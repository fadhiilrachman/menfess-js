...
export class CreatePostsTable1690486242921 implements MigrationInterface {
    name = 'CreatePostsTable1690486242921'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "file" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "path" character varying NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_36b46d232307066b3a2c9ea3a1d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b2d8e683f020f61115edea206b" ON "file" ("userId") `);
        await queryRunner.query(`CREATE TYPE "public"."posts_status_enum" AS ENUM('publish', 'draft')`);
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "content" text NOT NULL, "status" "public"."posts_status_enum" NOT NULL DEFAULT 'draft', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "photoId" uuid, "videoId" uuid, CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "posts" ADD CONSTRAINT "FK_c0e6e8c4bd59e6e015fe7cb307e" FOREIGN KEY ("photoId") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "posts" ADD CONSTRAINT "FK_fc1c107d5bae6bdb951c86bc4dc" FOREIGN KEY ("videoId") REFERENCES "file"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "posts" DROP CONSTRAINT "FK_fc1c107d5bae6bdb951c86bc4dc"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_b2d8e683f020f61115edea206b"`);
